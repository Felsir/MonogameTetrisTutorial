...
namespace Chapter43CC.Light
{
    public class ShadowCastingLight
    {
        private Vector3 _lightDirection;
        private BlendState[] _cascadeBlendState = new BlendState[3];
        ...
        public ShadowCastingLight(Vector3 lightDirection)
        {
            ...
            _cascadeBlendState[1] = new BlendState()
            {
            ...
            _cascadeBlendState[2] = new BlendState()
            {
        ...
        public BlendState CascadeBlendState(int cascade)
        {
            return _cascadeBlendState[cascade];
        }
